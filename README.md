...
### About the Subgraph
This subgraph dynamically tracks **all the transactions** (swaps) made via Paraswap on **BSC** (Binance Smart Chain). This subgraph supports Paraswap v4 and the latest v5 release.

> You can query the subgraph via GraphQL from the legacy explorer [here](https://thegraph.com/hosted-service/subgraph/paraswap/paraswap-subgraph-bsc).
